...
namespace Risecommerce\GeoIp\Model\GeoIpDatabase;

use Risecommerce\GeoIp\Model\Config;
use Magento\Framework\Archive\Gz;
use Magento\Framework\Archive\Tar;
/**
 * Class MaxMind
 * @package Risecommerce\GeoIp\Model\GeoIpDatabase
 */
class MaxMind
{
    /**
    ...
    public function update()
    {
        if ($this->config->getLicenseKey()) {
            ...
            return $this->updateByRisecommerceServer();
        }
    }
    /**
     * @return bool
     ...
     * @throws \Magento\Framework\Exception\LocalizedException
     */
    public function updateByRisecommerceServer()
    {
